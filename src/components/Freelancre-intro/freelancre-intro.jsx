          ...
          <div className="col-lg-8 valign">
            <div className="cont">
              <h1 className="cd-headline clip">
                We are BADFI, masters of tech and design. we blend creativity with cutting-edge technology to craft digital excellence. Let's transform your ideas into seamless-
                <span
